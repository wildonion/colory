...
parser.add_argument('--crossover-method', action='store', type=str, help='Crossover method to generate offspring (t-point[where t is an integer] or uniform).', required=True)
